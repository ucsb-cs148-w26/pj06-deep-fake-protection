...
Srish: giving progress texts to let everyone know where we are\

Start: \
Arman: requiring two approvals for merges\
Anit: star putting comments on the code at least one per function\
Henry: Utilize the Kanban and assign tasks to yourself, include better tasks descriptions\
John: Start allocating time outside of class to work on the project\

Stop:\
Srish: Please stop merging your own commits before approval \
