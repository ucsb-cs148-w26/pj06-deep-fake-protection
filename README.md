...
Click the select image button, then select an image you would like to protect. Ensure your image follows the guidelines, and then select the upload button. You will then be given the image with the filter placed on it.

Known Problems

We do not yet have the best image protection algorithm in place.
